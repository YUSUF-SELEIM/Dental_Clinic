...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="./logo.jpeg" class="h-8" alt="" />
    ...
    <section class="main">
        <div>
            <h2>Welcome to <br><span class="b">Dental Smile</span></h2>
            <h3>Creating Healthy
            <br>Beautiful Smiles for Life</h3>
<!-- Your HTML and PHP code -->
<form method="POST" >
<button type="submit" name="submit" class="main-btn" id="getStartedBtn">Get Started Now</button>
...
<!-- service -->
    ...
    <section id="services" class="bg-white dark:bg-gray-900 bg-blue-200 ">
        <div class= " py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 dark:bg-gray-900">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 dark:bg-gray-900">
                <div>
                    <div class="bg-blue-200 flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        <img src="./clean.png" class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                    </div>
                ...
                <div>
                    <div class="bg-blue-200 flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        <img src="./dental-implant.png" class="w-8 h-8 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"></path></svg>
                    </div>
                ...
                <div>
                    <div class="bg-blue-200  flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        <img src="./tooth.png" class="w-10 h-10 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clip-rule="evenodd"></path><path d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z"></path></svg>                    
                    </div>
...
<div  class="flex justify-center mt-8 pt-6 space-y-9  px-1 m-4 sm:flex-row sm:space-x-8 sm:space-y-0 dark:bg-gray-900">
     ...
     <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 dark:bg-gray-900">
        ...
        <div class="rounded overflow-hidden shadow-lg dark:bg-gray-900">
          <img class="w-full" src="./boy-dental-exam.jpeg" alt="Mountain">
          <div class="px-6 py-4">
        ...
        <!--Card 2-->
        <div class="rounded overflow-hidden shadow-lg dark:bg-gray-900">
          <img class="w-full" src="primary-school-boy-having-examination-iStock-639115580-scaled.jpg" alt="River">
          <div class="px-6 py-4">
        ...
        <!--Card 3-->
        <div class="rounded overflow-hidden shadow-lg dark:bg-gray-900">
          <img class="w-full" src="Children’s-Dental.jpg" alt="Forest">
          <div class="px-6 py-4">
...
<!--About us-->
      <section id="about" class="bg-blue-300 dark:bg-gray-900 ">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="Healthnet-146-HDR-Pano-scaled.jpg" alt="office content 1">
                <img class="mt-5 w-full lg:mt-10 rounded-lg" src="dental-clinic.jpg" alt="office content 2">
            </div>
        </div>
    </section>
            ...
            <div class="md:flex md:justify-between">
              <div class="mb-6 md:mb-0">
                  <a href="#" class="flex items-center">
                      <img src="./tooth (5).png" class="h-8 me-3" alt="FlowBite Logo" />
              ...
              <div class=" flex  gap-3 grid-cols-1   sm:grid-cols-2">
                  <div>
                      <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white"><img src="./phone-call.png " class="h-5 w-5"></h2>
                      <ul class="text-gray-500 dark:text-gray-400 font-medium">
                          <li class="mb-4">
                              <a href="#" class="hover:underline"><img src="./email.png" class="h-5 w-5"></a>
                          </li>
                          <li>
                              <a href="#" class="hover:underline"><img src="./location.png" class="h-5 w-5"></a>
                          </li>
                      </ul>
                  </div>
                  <div>
                      ...
                      <ul class="text-gray-500 dark:text-gray-400 font-medium">
                          ...
                          <li>
                              <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Alex,Moharam Bik</a>
                          </li>
                      </ul>
                  </div>
