...
$error_messenger_sign_in = '';
$error_messenger_log_in = '';
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_POST['sign-in-form']) && $_POST['sign-in-form'] == 1) {
        ...
        if ($result && $result->fetch_assoc()['count'] > 0) {
            $error_messenger_sign_in = "Email already exists. Please choose a different email.";
        } else {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $error_messenger_log_in = "Invalid email or password. Please try again.";
        }
    }
}
// echo $email;
...
<head>
    ...
    <script src="../js/form_validator.js" defer></script>
    <script>
        ...
        <div class="w-full  bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form id="form" class="space-y-4 md:space-y-6" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <?php
                    echo '<div class = "text-red-600" >' . $error_messenger_sign_in . '</div>';
                    ?>

                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email<span id="email-validation" class="text-lg text-red-600"> *</span></label>
                    ...
                    <div>
                        <label for="password" id="password-label" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password<span id="password-validation" class="text-lg text-red-600"> *</span></label>
                    ...
                    <div>
                        <label for="confirm-password" id="password-confirmation-label" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm password<span id="password-confirmation-validation" class="text-lg text-red-600"> *</span>
                        </label>
        ...
        <div class="w-full  bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form id="form" class="space-y-4 md:space-y-6" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <?php
                    echo '<div class = "text-red-600" >' . $error_messenger_log_in . '</div>';
                    ?>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email<span id="email-validation" class="text-lg text-red-600"> *</span></label>
                        <input type="email" name="email" id="email-I" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg   block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="john@doe.com" required>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    <div>
                        ...
                        <input type="email" name="email" id="bb" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="">
                    </div>
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                        <input type="password" name="password" id="aa" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                    </div>
